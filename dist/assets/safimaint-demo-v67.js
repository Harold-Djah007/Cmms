...
(function(){
  ...
  function demoState(){
    ...
    s.assets=[
      ...
      {id:'CHP-01',code:'CHP-01',name:'CHP Unit 01',type:'Equipment',parentId:'AREA-CHP',locationId:'AREA-CHP',siteId:'SITE-GH',category:'CHP',criticality:'A',condition:'Healthy',operatingState:'Online',location:'CHP Room · Engine bay 1',latitude:5.70442,longitude:-0.03074,ownerUserId:'U-2',ownerGroupId:'GRP-MAINT',manufacturer:'2G',model:'agenitor 408',serial:'2G-49811',warrantyExpiry:'2027-12-31',commissioned:'2020-09-04',account:'Power generation assets',chargeDepartment:'Maintenance',notes:'Primary biogas CHP unit. Record engine hours before every planned stop.',businessIds:['VEN-3'],customFields:{'Fuel type':'Biogas','Rated output':'280 kWe','Service class':'Critical generation'},warranties:[{id:'WAR-CHP-1',provider:'2G Energy service partner',reference:'2G-49811-WTY',start:'2020-09-04',expiry:'2027-12-31',coverage:'Engine and alternator parts; planned servicing excluded',status:'Active'}],bom:['PRT-1','PRT-4','PRT-5'],bomQuantities:{'PRT-1':2,'PRT-4':2,'PRT-5':4}},
