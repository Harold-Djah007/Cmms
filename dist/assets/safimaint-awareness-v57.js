...
(function(){
  ...
  document.addEventListener('input',e=>{if(e.target.matches('[data-v57-notice-search]')){ui.v57NoticeSearch=e.target.value;render()}},true);
