...
(function(){
  ...
  document.addEventListener('click',e=>{
    ...
    const child=e.target.closest('[data-v21-add-child]');if(child){e.preventDefault();e.stopImmediatePropagation();robustAssetEditor(null,String(child.dataset.v21AddChild));return}
