const CACHE='safimaint-asset-atlas-v78';
const APP_SHELL=[
  './',
  './index.html',
  ...
  './assets/safimaint-platform-states-v55.css',
  './assets/safimaint-purchasing-costing-v56.css',
  './assets/safimaint-awareness-v57.css',
  './assets/safimaint-file-sync-v58.css',
  './assets/safimaint-failure-hierarchy-v59.css',
  './assets/safimaint-command-center-v60.css',
  './assets/safimaint-compact-navigation-v61.css',
  './assets/safimaint-stock-control-v62.css',
  './assets/safimaint-interaction-bom-v63.css',
  './assets/safimaint-industrial-dashboard-v64.css',
  './assets/safimaint-fiix-shell-v65.css',
  './assets/safimaint-familiar-stock-v66.css',
  ...
  './assets/safimaint-assets-v77.css',
