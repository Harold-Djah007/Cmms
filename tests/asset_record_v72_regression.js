...
assert.match(source,/data-v72-map-toggle/);
assert.match(source,/Online map available/);
assert.match(css,/\.ar72-map\.expanded/);
assert.match(css,/\.ar72-map-live/);
assert.match(css,/\.ar72-qr/);
assert.match(source,/window\.SafiQR\.svg/);
